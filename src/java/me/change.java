...
public class change extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
           ...
           String p2=request.getParameter("w2");
           String p3=request.getParameter("w3");
     ...
     while(r.next())
       {
           ...
           {
               int i=sm.executeUpdate("update atm set pin="+p3+" where pin="+p1+"");
               if(i==1)
               {
                  
                   out.print("your pin has been changed");
                   
               }
            else
              out.print("unable to change pin");
        } }
