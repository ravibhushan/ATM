    ...
    throws ServletException, IOException {
        ...
        try {
           ...
           out.print("<body class='background'><h1>");
            ...
            String m3=request.getParameter("t3");
            String m4=request.getParameter("t4");
            String m5=request.getParameter("t5");
            String m6=request.getParameter("t6");
       ...
       int i=sm.executeUpdate("insert into atm values('"+m1+"','"+m2+"','"+m3+"','"+m4+"','"+m5+"','"+m6+"')");
         if(i==1)
            {
             out.print("<h2> The new member is added </h2>");
         }
 else
     out.print("insertion fails");
